...
<span class="line"><span style="color:#A6ACCD;">访问 http(s)://你的站点/e1bf6d26 进入管理面板，你可以在用户中心修改你的密码</span></span></code></pre></div><p><strong>現在lotusboard應該在 <a href="http://127.0.0.1" target="_blank" rel="noreferrer">http://127.0.0.1</a>:port提供服務了 (port是你在compose配置中所配置的)</strong></p><p><strong>如果提示隊列任務工作異常請執行</strong><code>dc restart</code> 來重啓面板</p>`,17),e=[o];function t(c,r,i,C,A,d){return a(),n("div",null,e)}const u=s(p,[["render",t]]);export{y as __pageData,u as default};
